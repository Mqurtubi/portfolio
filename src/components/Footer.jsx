...
export default function Footer(){
    return(
    <footer class="w-full p-4 bg-neutral-700  shadow-sm md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600 light:bg-neutral-400">
    <span class="text-sm text-neutral-300 sm:text-center dark:text-gray-400 light:text-neutral-800">© 2025 <a href="mailto:qurtubi1411@gmail.com" class="hover:underline">Muhammad Qurtubi™</a>. All Rights Reserved.
    </span>
