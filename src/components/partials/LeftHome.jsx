    ...
    return(
        <div className="">
                <div className="text-neutral-500 mt-10 mb-10 max-md:ml-6 max-md:max-w-[75%] " id="profile">
                    {step >= 1 && (<p className="typing-text1 text-2xl pb-2 max-sm:text-xl" >Hi I am</p>)}
                    {step >=2 && (<p className="typing-text2 text-4xl text-neutral-400 pb-4 max-sm:text-2xl" >Muhammad Qurtubi</p>)}
                    {step >=3 && (<p className="typing-text3  text-6xl text-amber-500 pt-6 font-bold max-sm:text-4xl max-sm:pt-2" >Web Developer</p>)}
                </div>
                {step >=4 &&(
                ...
                <div id="hasil" className="flex py-4 px-6 text-2xl/relaxed bg-neutral-700 rounded-lg max-sm:px-4 max-sm:text-lg max-sm:max-w-[80%] max-md:ml-6 max-md:max-w-[70%]">
                    ...
                    <div id="project" className="px-8 max-sm:px-2">
                        <p className="text-amber-600">20+</p>
